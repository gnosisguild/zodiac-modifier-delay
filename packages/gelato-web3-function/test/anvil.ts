// taken from https://github.com/gelatodigital/web3-functions-template/blob/master/test/utils/anvil-server.ts
// Copyright Gelato Digital - published under ISC License
import net from "net";
